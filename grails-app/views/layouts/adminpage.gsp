...
<body>
    ...
    <div class="menu-pane">
        <div class="menu-pane-row">
            <g:link controller="adminHome" action="index" class="tile" style="color: white;">
        ...
        <div class="menu-pane-row">
            <g:link controller="profile" action="index" class="tile" style="color: white;">
                <img src="${resource(dir: 'images', file: 'date_settings_white.png')}">
                <br/>
                <g:message code="default.application.profiles" default="Profiles" />
            </g:link> 
        </div>        
        <div class="menu-pane-row">
