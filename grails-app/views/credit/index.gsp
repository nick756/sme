...
<html>
    ...
    <body>
        ...
        <div class="action-header">
            ...
            <g:link style="float: right; margin-right: 5px;" controller="report" action="creditreport" target="_blank" params="['max': params.max, 'offset': params.offset]"><img class="image-link" style="margin-left: 5px;" src="${resource(dir: 'images', file: 'printer.png')}" title="<g:message code='actions.statement'/>"/></g:link>
        </div>
