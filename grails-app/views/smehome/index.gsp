...
<html>
    ...
    <body>
        ...
        <div class="action-header">
            <g:link style="float: right;" action="create" params="['max': params.max, 'offset': params.offset]"><img class="image-link" style="margin-right: 5px;" src="${resource(dir: 'images', file: 'add_record.png')}" title="<g:message code='actions.transaction.add'/>"/></g:link>
