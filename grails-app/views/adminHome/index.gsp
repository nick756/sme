...
<html>
    ...
    <body>
        <div class="action-header">
            ...
            <g:link style="float: right;" controller="adminHome" action="reportsettings" params="['max': params.max, 'offset': params.offset]"><img class="image-link" style="margin-right: 5px;" src="${resource(dir: 'images', file: 'chart01.png')}" title="<g:message code='actions.business.performanceReport'/>"/></g:link>
            <g:link style="float: right;" controller="adminHome" action="backuphistory" params="['max': params.max, 'offset': params.offset]"><img class="image-link" style="margin-right: 5px;" src="${resource(dir: 'images', file: 'data_copy.png')}" title="<g:message code='actions.business.exportpage'/>"/></g:link>
