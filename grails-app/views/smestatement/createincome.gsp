...
<html>
    ...
    <body>
        <div class="action-header">
            <g:link style="float: left; margin-left: 5px;" action="income" params="['max': params.max, 'offset': params.offset]"><img class="image-link" style="margin-left: 5px;" src="${resource(dir: 'images', file: 'arrow_left.png')}" title="<g:message code='actions.back'/>"/></g:link>
        </div> 
        <h1 class="sub-title"><g:message code="pnlstatement.new"/></h1>
        <g:if test="${errMsg != null}">
            <div class="error-message">${errMsg}</div>
        </g:if>
        <div class="edit-form-box" style="width: 100%; display: block; float: left;">
            <g:form action="generateincome" params="['max': params.max, 'offset': params.offset]">
