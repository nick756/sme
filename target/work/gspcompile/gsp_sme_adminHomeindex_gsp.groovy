...
invokeTag('link','g',22,['action':("add"),'params':(['max': params.max, 'offset': params.offset])],2)
printHtmlPart(8)
...
printHtmlPart(22)
invokeTag('formatDate','g',57,['format':("dd/MM/yyyy"),'date':(businessInstance?.incorpDate)],-1)
printHtmlPart(23)
...
printHtmlPart(25)
invokeTag('paginate','g',66,['total':(businessInstanceCount ?: 0)],-1)
printHtmlPart(26)
...
public static final long LAST_MODIFIED = 1435301297204L
