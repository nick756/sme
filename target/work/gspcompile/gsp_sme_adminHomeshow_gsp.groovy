...
createTagBody(2, {->
printHtmlPart(9)
expressionOut.print(resource(dir: 'images', file: 'list.png'))
printHtmlPart(6)
invokeTag('message','g',13,['code':("actions.profile")],-1)
printHtmlPart(7)
})
invokeTag('link','g',13,['action':("index"),'params':(['max': params.max, 'offset': params.offset])],2)
printHtmlPart(8)
createTagBody(2, {->
printHtmlPart(10)
...
invokeTag('link','g',14,['action':("index"),'params':(['max': params.max, 'offset': params.offset])],2)
printHtmlPart(11)
...
public static final long LAST_MODIFIED = 1435298310366L
